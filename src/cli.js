...
const cliConfig = {
  ...
  commands: [
    ...
    [
      'checkin2 <roomId> <name> <lang_nationality> <email> [phone]',
      'Checkin a guest with name, language & nationality code, email, phone. \n  ' +
      'ex) checkin2 2201 "Mrs. Pearl Brooks" en_US lge123@lge.com \n  ' +
      'ex) checkin2 2201 "Mrs. Pearl Brooks" de_DE lge123@lge.com 010-1234-5678\n  ',
      require('./command/checkin'),
    ],
    [
